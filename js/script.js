...
$('.advanced-events-slider').slick({
 ...
 $('.event-profile_slider').slick({
  ...
  $('.advanced-practices-slider').slick({
        slidesToShow: 3,
        slck: true,
        slidesToScroll: 1,
        prevArrow:'<span class="slick-previous"></span>',
